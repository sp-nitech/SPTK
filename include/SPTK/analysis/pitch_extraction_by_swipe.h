...
#ifndef SPTK_ANALYSIS_PITCH_EXTRACTION_BY_SWIPE_H_
#define SPTK_ANALYSIS_PITCH_EXTRACTION_BY_SWIPE_H_
...
class PitchExtractionBySwipe : public PitchExtractionInterface {
 public:
  ...
  ~PitchExtractionBySwipe() override {
  }
...
#endif  // SPTK_ANALYSIS_PITCH_EXTRACTION_BY_SWIPE_H_
