...
@test "mlsacheck: compatibility" {
   $sptk3/nrand -l 32 | $sptk3/mcep -l 16 -m 4 -a 0.1 | $sptk3/sopr -m 10 > tmp/1
   ...
   for i in $(seq 0 2); do
      for r in $(seq 1 1); do
         for p in $(seq 4 7); do
            $sptk3/mlsacheck -m 4 -a 0.1 ${ary1[$i]} -r $r -P $p tmp/1 > tmp/2
            $sptk4/mlsacheck -m 4 -a 0.1 ${ary2[$i]} -r $r -P $p -x tmp/1 > tmp/3
