...
#ifndef SPTK_MATH_SECOND_ORDER_ALL_PASS_INVERSE_FREQUENCY_TRANSFORM_H_
#define SPTK_MATH_SECOND_ORDER_ALL_PASS_INVERSE_FREQUENCY_TRANSFORM_H_
...
class SecondOrderAllPassInverseFrequencyTransform {
 public:
  ...
  virtual ~SecondOrderAllPassInverseFrequencyTransform() {
  }
  ...
  /**
   * @param[in] warped_sequence @f$M_1@f$-th order input sequence.
   * @param[out] minimum_phase_sequence @f$M_2@f$-th order output sequence.
   * @return True on success, false on failure.
   */
  bool Run(const std::vector<double>& warped_sequence,
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(SecondOrderAllPassInverseFrequencyTransform);
};

}  // namespace sptk

#endif  // SPTK_MATH_SECOND_ORDER_ALL_PASS_INVERSE_FREQUENCY_TRANSFORM_H_
