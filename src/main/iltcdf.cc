...
void PrintUsage(std::ostream* stream) {
  // clang-format off
  *stream << std::endl;
  *stream << " iltcdf - all-zero lattice digital filter for speech synthesis" << std::endl;  // NOLINT
  *stream << std::endl;
  *stream << "  usage:" << std::endl;
  *stream << "       iltcdf [ options ] kfile [ infile ] > stdout" << std::endl;
...
/**
 * @a iltcdf [ @e option ] @e kfile [ @e infile ]
 *
 * - @b -m @e int
